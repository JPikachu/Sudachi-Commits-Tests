...
void ConfigureFilesystem::SetConfiguration() {
    ui->nand_directory_edit->setText(
        QString::fromStdString(Common::FS::GetSudachiPathString(Common::FS::SudachiPath::NANDDir)));
    ui->sdmc_directory_edit->setText(
        QString::fromStdString(Common::FS::GetSudachiPathString(Common::FS::SudachiPath::SDMCDir)));
    ui->gamecard_path_edit->setText(
        QString::fromStdString(Settings::values.gamecard_path.GetValue()));
    ui->dump_path_edit->setText(
        QString::fromStdString(Common::FS::GetSudachiPathString(Common::FS::SudachiPath::DumpDir)));
    ui->load_path_edit->setText(
        QString::fromStdString(Common::FS::GetSudachiPathString(Common::FS::SudachiPath::LoadDir)));
...
void ConfigureFilesystem::ResetMetadata() {
    if (!Common::FS::Exists(Common::FS::GetSudachiPath(Common::FS::SudachiPath::CacheDir) /
                            "game_list/")) {
