...
#include "sudachi/multiplayer/direct_connect.h"
...
DirectConnectWindow::DirectConnectWindow(Core::System& system_, QWidget* parent)
    ...
    if (ui->nickname->text().isEmpty() && !Settings::values.sudachi_username.GetValue().empty()) {
        // Use sudachi Web Service user name as nickname by default
        ui->nickname->setText(QString::fromStdString(Settings::values.sudachi_username.GetValue()));
    }
