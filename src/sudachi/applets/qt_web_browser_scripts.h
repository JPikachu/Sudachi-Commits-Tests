...
var sudachi_key_callbacks = [];

(function() {
    class WindowNX {
        constructor() {
            sudachi_key_callbacks[1] = function() { window.history.back(); };
            sudachi_key_callbacks[2] = function() { window.nx.endApplet(); };
        }
    ...
    class WindowNXFooter {
        setAssign(key, label, func, option) {
            ...
            switch (key) {
                case "A":
                    sudachi_key_callbacks[0] = func;
                    break;
                case "B":
                    sudachi_key_callbacks[1] = func;
                    break;
                case "X":
                    sudachi_key_callbacks[2] = func;
                    break;
                case "Y":
                    sudachi_key_callbacks[3] = func;
                    break;
                case "L":
                    sudachi_key_callbacks[6] = func;
                    break;
                case "R":
                    sudachi_key_callbacks[7] = func;
                    break;
            }
        }
        ...
        unsetAssign(key) {
            ...
            switch (key) {
                case "A":
                    sudachi_key_callbacks[0] = function() {};
                    break;
                case "B":
                    sudachi_key_callbacks[1] = function() {};
                    break;
                case "X":
                    sudachi_key_callbacks[2] = function() {};
                    break;
                case "Y":
                    sudachi_key_callbacks[3] = function() {};
                    break;
                case "L":
                    sudachi_key_callbacks[6] = function() {};
                    break;
                case "R":
                    sudachi_key_callbacks[7] = function() {};
                    break;
            }
        }
    }
