...
#include "sudachi/applets/qt_web_browser_scripts.h"
#endif

#include "common/fs/path_util.h"
#include "core/core.h"
#include "input_common/drivers/keyboard.h"
#include "sudachi/applets/qt_web_browser.h"
#include "sudachi/main.h"
#include "sudachi/util/url_request_interceptor.h"
...
void QtNXWebEngineView::HandleWindowFooterButtonPressedOnce() {
    const auto f = [this](Core::HID::NpadButton button) {
        if (input_interpreter->IsButtonPressedOnce(button)) {
            ...
            page()->runJavaScript(
                QStringLiteral("sudachi_key_callbacks[%1] == null;").arg(button_index),
...
void QtNXWebEngineView::LoadExtractedFonts() {
    ...
    auto fonts_dir_str = Common::FS::PathToUTF8String(
        Common::FS::GetSudachiPath(Common::FS::SudachiPath::CacheDir) / "fonts/");
