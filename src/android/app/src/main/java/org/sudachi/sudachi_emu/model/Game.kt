...
class Game(
    ...
    val saveZipName: String
        get() = "$title ${SudachiApplication.appContext.getString(R.string.save_data).lowercase()} - ${
    ...
    val launchIntent: Intent
        get() = Intent(SudachiApplication.appContext, EmulationActivity::class.java).apply {
