...
import org.sudachi.sudachi_emu.features.DocumentProvider
...
class HomeSettingsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val optionsList: MutableList<HomeSetting> = mutableListOf<HomeSetting>().apply {
            ...
            add(
                HomeSetting(
                    R.string.manage_sudachi_data,
                    R.string.manage_sudachi_data_description,
    ...
    private fun shareLog() {
        val currentLog = DocumentFile.fromSingleUri(
            ...
            DocumentsContract.buildDocumentUri(
                ...
                "${DocumentProvider.ROOT_ID}/log/sudachi_log.txt"
            )
        )!!
        val oldLog = DocumentFile.fromSingleUri(
            ...
            DocumentsContract.buildDocumentUri(
                DocumentProvider.AUTHORITY,
                "${DocumentProvider.ROOT_ID}/log/sudachi_log.txt.old.txt"
            )
        )!!
