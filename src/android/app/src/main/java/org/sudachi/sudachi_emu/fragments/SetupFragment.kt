...
import org.sudachi.sudachi_emu.adapters.SetupAdapter
import org.sudachi.sudachi_emu.databinding.FragmentSetupBinding
...
class SetupFragment : Fragment() {
        ...
        pages.apply {
            ...
            add(
                SetupPage(
                    R.drawable.ic_key,
                    R.string.prod_keys,
                    R.string.keys_prod_description,
                    R.drawable.ic_add,
                    true,
            ...
            add(
                SetupPage(
                    R.drawable.ic_key,
                    R.string.title_keys,
                    R.string.keys_title_description,
                    R.drawable.ic_add,
                    true,
                    R.string.select_keys,
                    {
    ...
    private lateinit var prodKeyCallback: SetupCallback
    private lateinit var titleKeyCallback: SetupCallback

    val getProdKey =
        registerForActivityResult(ActivityResultContracts.OpenDocument()) { result ->
            if (result != null) {
                mainActivity.processProdKey(result)
                if (NativeLibrary.areKeysPresent()) {
                    prodKeyCallback.onStepCompleted()
                }
            }
        }
    ...
    private fun finishSetup() {
        PreferenceManager.getDefaultSharedPreferences(SudachiApplication.appContext).edit()
