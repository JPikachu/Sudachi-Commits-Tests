...
void Java_org_sudachi_sudachi_1emu_features_input_NativeInput_onGamePadButtonEvent(
...
void Java_org_sudachi_sudachi_1emu_features_input_NativeInput_onGamePadAxisEvent(
...
void Java_org_sudachi_sudachi_1emu_features_input_NativeInput_onGamePadMotionEvent(
...
void Java_org_sudachi_sudachi_1emu_features_input_NativeInput_onOverlayButtonEventImpl(
...
void Java_org_sudachi_sudachi_1emu_features_input_NativeInput_onOverlayJoystickEventImpl(
...
void Java_org_sudachi_sudachi_1emu_features_input_NativeInput_onDeviceMotionEvent(
...
jobjectArray Java_org_sudachi_sudachi_1emu_features_input_NativeInput_getInputProfileNames(
...
void Java_org_sudachi_sudachi_1emu_features_input_NativeInput_loadPerGameConfiguration(
...
void Java_org_sudachi_sudachi_1emu_features_input_NativeInput_setButtonParamImpl(
...
void Java_org_sudachi_sudachi_1emu_features_input_NativeInput_setStickParamImpl(
...
jintArray Java_org_sudachi_sudachi_1emu_features_input_NativeInput_getSupportedStyleTagsImpl(
...
void Java_org_sudachi_sudachi_1emu_features_input_NativeInput_connectControllersImpl(
...
void Java_org_sudachi_sudachi_1emu_features_input_NativeInput_resetControllerMappings(
    JNIEnv* env, jobject j_obj, jint j_player_index) {
    // Clear all previous mappings
    for (int button_id = 0; button_id < Settings::NativeButton::NumButtons; ++button_id) {
        ApplyControllerConfig(j_player_index, [&](Core::HID::EmulatedController* controller) {
