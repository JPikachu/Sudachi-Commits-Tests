...
static jclass s_sudachi_input_device_interface;
static jmethodID s_sudachi_input_device_get_name;
static jmethodID s_sudachi_input_device_get_guid;
static jmethodID s_sudachi_input_device_get_port;
static jmethodID s_sudachi_input_device_get_supports_vibration;
static jmethodID s_sudachi_input_device_vibrate;
static jmethodID s_sudachi_input_device_get_axes;
static jmethodID s_sudachi_input_device_has_keys;
...
jclass GetSudachiInputDeviceInterface() {
    return s_sudachi_input_device_interface;
}

jmethodID GetSudachiDeviceGetName() {
    return s_sudachi_input_device_get_name;
}

jmethodID GetSudachiDeviceGetGUID() {
    return s_sudachi_input_device_get_guid;
}

jmethodID GetSudachiDeviceGetPort() {
    return s_sudachi_input_device_get_port;
}

jmethodID GetSudachiDeviceGetSupportsVibration() {
    return s_sudachi_input_device_get_supports_vibration;
}

jmethodID GetSudachiDeviceVibrate() {
    return s_sudachi_input_device_vibrate;
}

jmethodID GetSudachiDeviceGetAxes() {
    return s_sudachi_input_device_get_axes;
}

jmethodID GetSudachiDeviceHasKeys() {
    return s_sudachi_input_device_has_keys;
}
...
jint JNI_OnLoad(JavaVM* vm, void* reserved) {
    ...
    const jclass player_input_class =
        env->FindClass("org/sudachi/sudachi_emu/features/input/model/PlayerInput");
    ...
    const jclass sudachi_input_device_interface =
        env->FindClass("org/sudachi/sudachi_emu/features/input/SudachiInputDevice");
    s_sudachi_input_device_interface =
        reinterpret_cast<jclass>(env->NewGlobalRef(sudachi_input_device_interface));
    s_sudachi_input_device_get_name =
    ...
    s_sudachi_input_device_has_keys =
        env->GetMethodID(sudachi_input_device_interface, "hasKeys", "([I)[Z");
    env->DeleteLocalRef(sudachi_input_device_interface);
...
void JNI_OnUnload(JavaVM* vm, void* reserved) {
    ...
    env->DeleteGlobalRef(s_sudachi_input_device_interface);
