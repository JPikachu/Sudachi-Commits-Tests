...
public:
    SUDACHI_NON_COPYABLE(OGLRenderbuffer);
...
public:
    SUDACHI_NON_COPYABLE(OGLTexture);
...
public:
    SUDACHI_NON_COPYABLE(OGLTextureView);
...
public:
    SUDACHI_NON_COPYABLE(OGLSampler);
...
public:
    SUDACHI_NON_COPYABLE(OGLShader);
...
public:
    SUDACHI_NON_COPYABLE(OGLProgram);
...
public:
    SUDACHI_NON_COPYABLE(OGLAssemblyProgram);
...
public:
    SUDACHI_NON_COPYABLE(OGLPipeline);
...
public:
    SUDACHI_NON_COPYABLE(OGLBuffer);
...
public:
    SUDACHI_NON_COPYABLE(OGLFramebuffer);
...
public:
    SUDACHI_NON_COPYABLE(OGLTransformFeedback);
