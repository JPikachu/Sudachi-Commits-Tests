...
void ExtractSharedFonts(Core::System& system) {
    ...
    const auto fonts_dir = Common::FS::GetSudachiPath(Common::FS::SudachiPath::CacheDir) / "fonts";
...
void WebBrowser::InitializeOffline() {
    ...
    offline_cache_dir = Common::FS::GetSudachiPath(Common::FS::SudachiPath::CacheDir) /
