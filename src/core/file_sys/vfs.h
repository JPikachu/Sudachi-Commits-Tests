...
class VfsFilesystem {
public:
    SUDACHI_NON_COPYABLE(VfsFilesystem);
    SUDACHI_NON_MOVEABLE(VfsFilesystem);
...
class VfsFile {
public:
    SUDACHI_NON_COPYABLE(VfsFile);
    SUDACHI_NON_MOVEABLE(VfsFile);
...
class VfsDirectory {
public:
    SUDACHI_NON_COPYABLE(VfsDirectory);
    SUDACHI_NON_MOVEABLE(VfsDirectory);
